...
├── paper/
│   └── Student_Academic_Performance_Predict.docx     # IEEE research paper (Word format)
├── results/
│   └── model_performance_summary.txt                 # Model evaluation results
├── submission_proof/
│   └── Submission_Proof.pdf                          # Proof of paper submission
└── README.md
```
